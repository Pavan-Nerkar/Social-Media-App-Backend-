...
import com.nerkar.response.ApiResponse;
import com.nerkar.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<ApiResponse> deletePost(@RequestHeader("Authorization") String jwt, @PathVariable int postId) throws Exception{
		...
		ApiResponse res = new ApiResponse(message," Deleted Successfully");
	...
	public ResponseEntity<Post> savedPostHandler(@RequestHeader("Authorization") String jwt, @PathVariable int postId) throws Exception{
	...
	public ResponseEntity<Post> likePostHandler(@RequestHeader("Authorization") String jwt, @PathVariable int postId) throws Exception{
